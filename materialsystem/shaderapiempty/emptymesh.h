...
//
// Purpose: Declaration of CEmptyMesh, the no-op IMesh placeholder. The
//          implementation lives in shaderapiempty.cpp; the declaration is
//          shared so a real backend (shaderapidx11) can hand out the same
//          non-null placeholders from its IShaderDevice mesh factories.
//          Callers (studiorender, materialsystem mesh code) dereference
//          whatever CreateStaticMesh & friends return, so returning NULL
//          here is not an option - see CShaderDeviceDx11.
//
//===========================================================================//
