...
public:
	...
	virtual uintp GetCurrentIMEHandle() = 0;
	virtual uintp GetEnglishIMEHandle() = 0;
	...
	virtual void OnChangeIMEByHandle( uintp handleValue ) = 0;
	virtual void OnChangeIMEConversionModeByHandle( uintp handleValue ) = 0;
	virtual void OnChangeIMESentenceModeByHandle( uintp handleValue ) = 0;
